    ...
    adminHtml = adminHtml.replace(
        ...
        `<div class="admin-header">
            ...
            <div style="display:flex; align-items:center;">
                <a href="#" id="theme-toggle" title="Cambiar Tema" style="margin-right: 20px; font-size: 1.5rem; color: #111;"><i class="fa-solid fa-moon"></i><i class="fa-solid fa-sun"></i></a>
                <a href="#" id="logout-btn" class="btn" style="background:#ff4757; color:white;">Cerrar Sesión</a>
            </div>`
    );
    // Since we replaced the logout button area, let's remove the old one if it was there
    adminHtml = adminHtml.replace(/<a href="#" id="logout-btn" class="btn" style="background:#ff4757; color:white;">Cerrar Sesión<\/a>\s*<\/div>\s*<\/div>/, '</div>');

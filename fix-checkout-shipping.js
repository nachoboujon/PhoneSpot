...
const regexShipping = /const citySelect = document\.getElementById\('chk-city'\);[\s\S]*?checkoutItems\.innerHTML \+= `[\s\S]*?<\/div>[\s\S]*?`;\s*\}/;
...
// Wait, the checkout submit logic also checks city === 'Otra'
...
console.log('script.js total and shipping calculations updated');
